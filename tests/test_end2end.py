...
from main import app, ZIP_PATH, RAW_DATA_PATH, DB_PATH, VECTORS_PATH, QUERY, TOP_N
...
def test_search_podcasts(client, setup_environment):
    ...
    assert response_ranks[0][1] > response_ranks[1][1] > response_ranks[2][1] > response_ranks[3][1] > response_ranks[4][1] # Assert results are valid
